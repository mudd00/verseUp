...
import { RigidBody, RapierRigidBody, CapsuleCollider, useBeforePhysicsStep } from '@react-three/rapier'
...
const Player = forwardRef<THREE.Group, PlayerProps>(({ cameraAngle }, ref) => {
  ...
  // ref를 외부에 노출
  useImperativeHandle(ref, () => characterRef.current as THREE.Group)
